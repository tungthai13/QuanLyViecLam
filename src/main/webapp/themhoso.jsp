                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form method="POST"  action="themHoSo">
                                        ...
                                        <div class="form-group">
                                            <label>CV</label>
                                            <input type="float" required name="cv" class="form-control">

                                        </div>
                                        <div class="form-group">
                                            <label>Nội dung ứng tuyển</label>
                                            <input type="text" required name="noiDungUngTuyen" class="form-control">

                                        </div>
                                        <div class="form-group">
                                            <label>ID người dùng</label>
                                            <input type="float" required name="idUser" class="form-control">
